...
app.get('/v1/contacts/', passport.authenticate('basic', {
	session: false
...
app.get('/v1/contacts/:primarycontactnumber', passport.authenticate('basic', {
	session: false
}), function (request, response) {
...
app.get('/contacts/:primarycontactnumber/image', passport.authenticate('basic', {
	session: false
}), function (request, response) {
...
app.get('/v2/contacts', cache('minutes', 1), passport.authenticate('basic', {
	session: false
}), function (request, response) {
